...
public class EditStudentController implements Initializable {
    ...
    private final StudentBUS studentBus = new StudentBUS();
        ...
        saveBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if(firstName.equals("") || lastName.equals("") || phoneNumber.equals("")){
                    ...
                    teacher = studentBus.updateStudent(teacher);
                    if(teacher!=null){
    ...
    public void setDefault(){
        ...
        birthDatePicker.setValue(Controller.selectedRow.getDateOfBirth().toLocalDate());
