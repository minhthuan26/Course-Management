...
//                +"set FirstName="+"'"+person.getFirstName()+"'" +"LastName="+"'"+person.getLastName()+"PhoneNumber="+"'"+person.getPhoneNumber()+"'"
//                +"Email=" +"'"+person.getEmail()+"DateOfBirth"+"'"+person.getDateOfBirth()+"PersonImage"+"''"
//                +"where PersonID="+person.getPersonId();
//        try {
//            result=connect.ExecuteUpdate(query);
//            if (result == 0)
